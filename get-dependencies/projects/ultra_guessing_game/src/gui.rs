...
// Returns the index of the chosen game (1–9) or None if the user closes.
...
pub struct LauncherApp {
    /// Selected game index (1–9) when user clicks a button.
...
// ── Public entry-point ────────────────────────────────────────────────────────
/// Launch the GUI launcher window and return the selected game index (1–9),
