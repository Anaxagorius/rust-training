...
pub fn all_enemy_templates() -> Vec<EnemyTemplate> {
    vec![
        ...
        // Ember Coast
        EnemyTemplate {
            id: "saltstone_crab".to_string(),
            name: "Saltstone Crab".to_string(),
            level: 2, base_hp: 30,
            stats: Stats::new(4, 1, 1, 6, 4, 1),
            armor: 5, weapon_damage: 6,
            damage_type: DamageType::Physical,
            resistances: { let mut r = ElementalResistances::none(); r.physical = 20; r },
            xp_reward: 28, gold_min: 0, gold_max: 2,
            loot_item_ids: vec!["sea_salt".to_string(), "chitinous_shell".to_string()],
            description: "A barnacle-encrusted crab whose shell is as hard as stone.".to_string(),
            abilities: vec!["Pincer Crush".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "coastal_raider".to_string(),
            name: "Coastal Raider".to_string(),
            level: 3, base_hp: 50,
            stats: Stats::new(7, 3, 3, 6, 7, 3),
            armor: 3, weapon_damage: 10,
            damage_type: DamageType::Physical,
            resistances: ElementalResistances::none(),
            xp_reward: 55, gold_min: 5, gold_max: 15,
            loot_item_ids: vec!["crude_sword".to_string(), "driftwood".to_string()],
            description: "A seaborne bandit who raids coastal settlements from longboats.".to_string(),
            abilities: vec!["Boarding Rush".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "tide_wraith".to_string(),
            name: "Tide Wraith".to_string(),
            level: 5, base_hp: 70,
            stats: Stats::new(5, 12, 10, 5, 8, 3),
            armor: 0, weapon_damage: 15,
            damage_type: DamageType::Psychic,
            resistances: { let mut r = ElementalResistances::none(); r.poison = 100; r.physical = 40; r },
            xp_reward: 160, gold_min: 0, gold_max: 5,
            loot_item_ids: vec!["ghost_essence".to_string(), "sea_salt".to_string()],
            description: "A drowned spirit that haunts the sea mist, luring sailors to their doom.".to_string(),
            abilities: vec!["Drowning Touch".to_string(), "Wail of the Deep".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "sea_serpent".to_string(),
            name: "Sea Serpent".to_string(),
            level: 5, base_hp: 95,
            stats: Stats::new(12, 4, 3, 10, 7, 2),
            armor: 4, weapon_damage: 16,
            damage_type: DamageType::Poison,
            resistances: { let mut r = ElementalResistances::none(); r.nature = 20; r.poison = 30; r },
            xp_reward: 175, gold_min: 0, gold_max: 8,
            loot_item_ids: vec!["serpent_scale".to_string(), "sinew".to_string()],
            description: "A massive serpent that lurks in the coastal shallows, hunting from the fog.".to_string(),
            abilities: vec!["Constrict".to_string(), "Venom Spray".to_string()],
            on_death_status: Some(StatusEffect::Poison { damage_per_turn: 3, turns_remaining: 3 }),
        },
        // Iron Quarry
        EnemyTemplate {
            id: "mine_crawler".to_string(),
            name: "Mine Crawler".to_string(),
            level: 3, base_hp: 40,
            stats: Stats::new(5, 1, 1, 7, 8, 1),
            armor: 3, weapon_damage: 8,
            damage_type: DamageType::Poison,
            resistances: ElementalResistances::none(),
            xp_reward: 50, gold_min: 0, gold_max: 2,
            loot_item_ids: vec!["chitinous_shell".to_string()],
            description: "An insect the size of a hound that infests the quarry tunnels.".to_string(),
            abilities: vec!["Acid Spit".to_string()],
            on_death_status: Some(StatusEffect::Poison { damage_per_turn: 2, turns_remaining: 2 }),
        },
        EnemyTemplate {
            id: "quarry_bandit".to_string(),
            name: "Quarry Bandit".to_string(),
            level: 3, base_hp: 52,
            stats: Stats::new(8, 3, 2, 7, 5, 3),
            armor: 3, weapon_damage: 10,
            damage_type: DamageType::Physical,
            resistances: ElementalResistances::none(),
            xp_reward: 58, gold_min: 4, gold_max: 14,
            loot_item_ids: vec!["iron_ore".to_string(), "crude_knife".to_string()],
            description: "A brigand who has seized the quarry to sell stolen ore on the black market.".to_string(),
            abilities: vec!["Pick Swing".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "rock_wyrm".to_string(),
            name: "Rock Wyrm".to_string(),
            level: 5, base_hp: 105,
            stats: Stats::new(14, 2, 2, 15, 4, 1),
            armor: 7, weapon_damage: 17,
            damage_type: DamageType::Physical,
            resistances: { let mut r = ElementalResistances::none(); r.physical = 20; r.fire = -10; r },
            xp_reward: 185, gold_min: 0, gold_max: 10,
            loot_item_ids: vec!["iron_ore".to_string(), "crystal_shard".to_string()],
            description: "A serpentine creature of compressed stone that tunnels through solid rock.".to_string(),
            abilities: vec!["Burrow Strike".to_string(), "Stone Crush".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "iron_golem".to_string(),
            name: "Iron Golem".to_string(),
            level: 6, base_hp: 130,
            stats: Stats::new(16, 3, 2, 18, 2, 1),
            armor: 12, weapon_damage: 19,
            damage_type: DamageType::Physical,
            resistances: { let mut r = ElementalResistances::none(); r.physical = 30; r.poison = 100; r.fire = -30; r },
            xp_reward: 260, gold_min: 0, gold_max: 12,
            loot_item_ids: vec!["iron_ingot".to_string(), "black_iron_ingot".to_string()],
            description: "A massive construct of wrought iron, animated by an ancient smithing ritual. \
                          Impervious to most weapons and catastrophically vulnerable to heat.".to_string(),
            abilities: vec!["Iron Fist".to_string(), "Quake Stomp".to_string()],
            on_death_status: None,
        },
        // Sunken Temple
        EnemyTemplate {
            id: "temple_serpent".to_string(),
            name: "Temple Serpent".to_string(),
            level: 3, base_hp: 42,
            stats: Stats::new(5, 2, 2, 5, 10, 1),
            armor: 1, weapon_damage: 9,
            damage_type: DamageType::Poison,
            resistances: { let mut r = ElementalResistances::none(); r.nature = 15; r },
            xp_reward: 52, gold_min: 0, gold_max: 2,
            loot_item_ids: vec!["serpent_scale".to_string()],
            description: "A venomous serpent coiled around an altar in the sunken temple.".to_string(),
            abilities: vec!["Venom Bite".to_string()],
            on_death_status: Some(StatusEffect::Poison { damage_per_turn: 2, turns_remaining: 3 }),
        },
        EnemyTemplate {
            id: "cursed_acolyte".to_string(),
            name: "Cursed Acolyte".to_string(),
            level: 4, base_hp: 55,
            stats: Stats::new(5, 10, 8, 6, 6, 2),
            armor: 1, weapon_damage: 12,
            damage_type: DamageType::Psychic,
            resistances: { let mut r = ElementalResistances::none(); r.poison = 50; r },
            xp_reward: 90, gold_min: 0, gold_max: 8,
            loot_item_ids: vec!["temple_relic".to_string(), "ancient_coin".to_string()],
            description: "A former priest twisted by the temple's dark rituals into an undead servant.".to_string(),
            abilities: vec!["Dark Prayer".to_string(), "Curse Bolt".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "temple_guardian_spirit".to_string(),
            name: "Temple Guardian Spirit".to_string(),
            level: 5, base_hp: 80,
            stats: Stats::new(8, 12, 10, 8, 7, 4),
            armor: 2, weapon_damage: 14,
            damage_type: DamageType::Psychic,
            resistances: { let mut r = ElementalResistances::none(); r.poison = 100; r.physical = 35; r.fire = 15; r },
            xp_reward: 170, gold_min: 0, gold_max: 10,
            loot_item_ids: vec!["ghost_essence".to_string(), "temple_relic".to_string()],
            description: "An ancient spirit bound to protect the temple's sanctum for all eternity.".to_string(),
            abilities: vec!["Spirit Strike".to_string(), "Ward of the Ancients".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "idol_construct".to_string(),
            name: "Idol Construct".to_string(),
            level: 6, base_hp: 120,
            stats: Stats::new(14, 7, 5, 15, 5, 2),
            armor: 9, weapon_damage: 18,
            damage_type: DamageType::Physical,
            resistances: { let mut r = ElementalResistances::none(); r.physical = 25; r.poison = 100; r.nature = 20; r },
            xp_reward: 240, gold_min: 10, gold_max: 30,
            loot_item_ids: vec!["temple_relic".to_string(), "ancient_coin".to_string(), "carved_bone".to_string()],
            description: "A stone idol animated by the temple's residual power. Its purpose: destroy all intruders.".to_string(),
            abilities: vec!["Idol Smash".to_string(), "Ancient Decree".to_string(), "Stone Prison".to_string()],
            on_death_status: None,
        },
        // Frostpeak
        EnemyTemplate {
            id: "snow_eagle".to_string(),
            name: "Snow Eagle".to_string(),
            level: 2, base_hp: 25,
            stats: Stats::new(3, 1, 1, 3, 12, 1),
            armor: 0, weapon_damage: 7,
            damage_type: DamageType::Physical,
            resistances: ElementalResistances::none(),
            xp_reward: 22, gold_min: 0, gold_max: 0,
            loot_item_ids: vec!["harpy_feather".to_string()],
            description: "A large eagle that swoops from the frozen peaks to attack travellers.".to_string(),
            abilities: vec!["Dive Strike".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "frost_wolf".to_string(),
            name: "Frost Wolf".to_string(),
            level: 3, base_hp: 48,
            stats: Stats::new(7, 2, 2, 6, 9, 1),
            armor: 1, weapon_damage: 10,
            damage_type: DamageType::Physical,
            resistances: ElementalResistances::none(),
            xp_reward: 60, gold_min: 0, gold_max: 3,
            loot_item_ids: vec!["wolf_pelt".to_string(), "frost_crystal".to_string()],
            description: "A white wolf of the high peaks, its fur thick with permafrost.".to_string(),
            abilities: vec!["Frost Bite".to_string(), "Pack Howl".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "ice_troll".to_string(),
            name: "Ice Troll".to_string(),
            level: 5, base_hp: 115,
            stats: Stats::new(15, 2, 2, 16, 3, 1),
            armor: 5, weapon_damage: 18,
            damage_type: DamageType::Physical,
            resistances: { let mut r = ElementalResistances::none(); r.physical = 15; r.fire = -30; r },
            xp_reward: 190, gold_min: 0, gold_max: 8,
            loot_item_ids: vec!["glacier_shard".to_string(), "iron_ingot".to_string()],
            description: "A blue-skinned troll that lurks in crevasses, ambushing travellers on the frozen passes.".to_string(),
            abilities: vec!["Glacier Slam".to_string(), "Frost Breath".to_string(), "Regenerate".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "glacial_wraith".to_string(),
            name: "Glacial Wraith".to_string(),
            level: 6, base_hp: 85,
            stats: Stats::new(6, 13, 11, 7, 9, 3),
            armor: 0, weapon_damage: 17,
            damage_type: DamageType::Psychic,
            resistances: { let mut r = ElementalResistances::none(); r.poison = 100; r.physical = 50; r.fire = -20; r },
            xp_reward: 230, gold_min: 0, gold_max: 5,
            loot_item_ids: vec!["ghost_essence".to_string(), "glacier_shard".to_string()],
            description: "A spirit crystallised within an ancient glacier, its touch drains warmth and will.".to_string(),
            abilities: vec!["Freeze Touch".to_string(), "Glacial Wail".to_string(), "Ethereal Form".to_string()],
            on_death_status: None,
        },
        // Bonus / wandering enemies
        EnemyTemplate {
            id: "harpy".to_string(),
            name: "Harpy".to_string(),
            level: 3, base_hp: 38,
            stats: Stats::new(5, 4, 3, 5, 11, 4),
            armor: 1, weapon_damage: 9,
            damage_type: DamageType::Physical,
            resistances: ElementalResistances::none(),
            xp_reward: 55, gold_min: 0, gold_max: 4,
            loot_item_ids: vec!["harpy_feather".to_string(), "meat".to_string()],
            description: "A winged creature with the body of a great bird and the cunning of a \
                          human. It swoops to steal and slash.".to_string(),
            abilities: vec!["Shriek".to_string(), "Talon Strike".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "river_serpent".to_string(),
            name: "River Serpent".to_string(),
            level: 3, base_hp: 45,
            stats: Stats::new(7, 2, 2, 7, 8, 1),
            armor: 2, weapon_damage: 9,
            damage_type: DamageType::Poison,
            resistances: { let mut r = ElementalResistances::none(); r.nature = 10; r },
            xp_reward: 50, gold_min: 0, gold_max: 3,
            loot_item_ids: vec!["serpent_scale".to_string(), "sinew".to_string()],
            description: "A large serpent that lurks in river shallows and coastal inlets.".to_string(),
            abilities: vec!["Constrict".to_string()],
            on_death_status: Some(StatusEffect::Poison { damage_per_turn: 2, turns_remaining: 2 }),
        },
        EnemyTemplate {
            id: "bone_colossus".to_string(),
            name: "Bone Colossus".to_string(),
            level: 8, base_hp: 180,
            stats: Stats::new(18, 6, 4, 20, 4, 2),
            armor: 10, weapon_damage: 24,
            damage_type: DamageType::Physical,
            resistances: { let mut r = ElementalResistances::none(); r.poison = 100; r.physical = 25; r.fire = -25; r },
            xp_reward: 600, gold_min: 25, gold_max: 60,
            loot_item_ids: vec!["carved_bone".to_string(), "ancient_coin".to_string(), "ghost_essence".to_string()],
            description: "A colossal undead construct assembled from the bones of a hundred fallen warriors. \
                          The apex guardian of the Sunken Temple sanctum.".to_string(),
            abilities: vec!["Bone Avalanche".to_string(), "Undead Fury".to_string(), "Osseous Shield".to_string()],
            on_death_status: None,
        },
        EnemyTemplate {
            id: "marsh_phantom".to_string(),
            name: "Marsh Phantom".to_string(),
            level: 5, base_hp: 72,
            stats: Stats::new(5, 11, 9, 6, 9, 2),
            armor: 0, weapon_damage: 14,
            damage_type: DamageType::Poison,
            resistances: { let mut r = ElementalResistances::none(); r.poison = 75; r.physical = 30; r.nature = 25; r },
            xp_reward: 155, gold_min: 0, gold_max: 6,
            loot_item_ids: vec!["ghost_essence".to_string(), "bog_moss".to_string()],
            description: "A miasmatic spirit born from the swamp's poisoned depths. It drifts silently \
                          through the mists, draining the life of those it touches.".to_string(),
...
pub fn all_items() -> Vec<Item> {
    vec![
        ...
        // New zone materials
        Item::new_consumable("driftwood", "Driftwood", ItemType::CraftingMaterial, 5),
        Item::new_consumable("sea_salt", "Sea Salt", ItemType::CraftingMaterial, 8),
        Item::new_consumable("serpent_scale", "Serpent Scale", ItemType::CraftingMaterial, 8),
        Item::new_consumable("harpy_feather", "Harpy Feather", ItemType::CraftingMaterial, 12),
        Item::new_consumable("iron_ore", "Iron Ore", ItemType::CraftingMaterial, 8),
        Item::new_consumable("black_iron_ingot", "Black Iron Ingot", ItemType::CraftingMaterial, 15),
        Item::new_consumable("temple_relic", "Temple Relic", ItemType::CraftingMaterial, 1),
        Item::new_consumable("frost_crystal", "Frost Crystal", ItemType::CraftingMaterial, 10),
        Item::new_consumable("glacier_shard", "Glacier Shard", ItemType::CraftingMaterial, 12),
        Item::new_consumable("sea_coal", "Sea Coal", ItemType::CraftingMaterial, 6),
        // New equipment from new zones
        Item::new_armor("iron_chainmail", "Iron Chainmail", EquipSlot::Torso, MaterialTier::Iron, ItemRarity::Uncommon, 9),
        Item::new_armor("iron_round_shield", "Iron Round Shield", EquipSlot::OffHand, MaterialTier::Iron, ItemRarity::Common, 8),
        ...
        Item {
            ...
            name: "Frostpeak Amulet".to_string(),
            item_type: ItemType::Amulet,
            material: None,
            rarity: ItemRarity::Rare,
            weight: 0.2,
            ...
            armor_base: 0,
            stat_requirements: Stats::zeroed(),
            stat_bonuses: Stats::new(0, 0, 2, 2, 0, 0),
            equip_slot: Some(EquipSlot::Amulet),
            stack_size: 1,
            quantity: 1,
            description: "An amulet carved from glacier ice, preserved by ancient magic. +2 WIS, +2 CON.".to_string(),
            effects: Vec::new(),
            is_two_handed: false,
        },
        Item {
            id: "temple_seal_amulet".to_string(),
            name: "Temple Seal Amulet".to_string(),
            item_type: ItemType::Amulet,
            material: None,
            rarity: ItemRarity::Rare,
            weight: 0.2,
            ...
            armor_base: 0,
            stat_requirements: Stats::zeroed(),
            stat_bonuses: Stats::new(0, 3, 1, 0, 0, 1),
            equip_slot: Some(EquipSlot::Amulet),
            stack_size: 1,
            quantity: 1,
...
pub fn all_loot_tables() -> Vec<LootTable> {
    vec![
        ...
        // ── Ember Coast ───────────────────────────────────────────────────────
        LootTable {
            id: "ember_coast_shore".to_string(),
            flavor_text: "You search the rocky shore. Driftwood, old rope, and the scattered \
                          remnants of wrecked boats litter the beach.".to_string(),
            guaranteed_items: vec![("driftwood".to_string(), 2)],
            random_entries: vec![
                LootEntry { item_id: "sea_salt".to_string(), weight: 60, quantity_min: 1, quantity_max: 3 },
                LootEntry { item_id: "sinew".to_string(), weight: 30, quantity_min: 1, quantity_max: 2 },
                LootEntry { item_id: "serpent_scale".to_string(), weight: 20, quantity_min: 1, quantity_max: 1 },
            ],
            gold_min: 0, gold_max: 6,
            roll_count: 2,
        },
        LootTable {
            id: "ember_coast_ruins".to_string(),
            flavor_text: "Crumbling sea-fort walls yield a trove of old plunder — raider \
                          goods and salvage from wrecked vessels.".to_string(),
            guaranteed_items: vec![("ancient_coin".to_string(), 2)],
            random_entries: vec![
                LootEntry { item_id: "crude_sword".to_string(), weight: 40, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "iron_ingot".to_string(), weight: 35, quantity_min: 1, quantity_max: 2 },
                LootEntry { item_id: "leather".to_string(), weight: 50, quantity_min: 1, quantity_max: 3 },
                LootEntry { item_id: "health_potion".to_string(), weight: 25, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "serpent_scale_armor".to_string(), weight: 15, quantity_min: 1, quantity_max: 1 },
            ],
        ...
        // ── Iron Quarry ───────────────────────────────────────────────────────
        LootTable {
            id: "iron_quarry_entrance".to_string(),
            flavor_text: "You sift through the quarry debris at the entrance. \
                          Bandit refuse and ore tailings are scattered about.".to_string(),
            guaranteed_items: vec![("iron_ore".to_string(), 2)],
            random_entries: vec![
                LootEntry { item_id: "iron_ingot".to_string(), weight: 50, quantity_min: 1, quantity_max: 2 },
                LootEntry { item_id: "crude_knife".to_string(), weight: 30, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "wood_shaft".to_string(), weight: 40, quantity_min: 1, quantity_max: 2 },
            ],
            gold_min: 3, gold_max: 12,
            roll_count: 1,
        },
        LootTable {
            id: "iron_quarry_depths".to_string(),
            flavor_text: "The deepest seam of the quarry is rich with ore and the hoarded \
                          supplies of the brigands who seized it.".to_string(),
            guaranteed_items: vec![
                ("iron_ore".to_string(), 3),
                ("iron_ingot".to_string(), 2),
            ],
            random_entries: vec![
                LootEntry { item_id: "black_iron_ingot".to_string(), weight: 35, quantity_min: 1, quantity_max: 2 },
                LootEntry { item_id: "iron_chainmail".to_string(), weight: 20, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "health_potion".to_string(), weight: 40, quantity_min: 1, quantity_max: 2 },
                LootEntry { item_id: "iron_round_shield".to_string(), weight: 25, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "crystal_shard".to_string(), weight: 30, quantity_min: 1, quantity_max: 2 },
            ],
        ...
        // ── Sunken Temple ─────────────────────────────────────────────────────
        LootTable {
            id: "sunken_temple_entrance".to_string(),
            flavor_text: "The waterlogged antechamber yields offerings left by long-dead worshippers — \
                          still untouched after centuries beneath the waves.".to_string(),
            guaranteed_items: vec![
                ("ancient_coin".to_string(), 3),
                ("temple_relic".to_string(), 1),
            ],
            random_entries: vec![
                LootEntry { item_id: "carved_bone".to_string(), weight: 40, quantity_min: 1, quantity_max: 2 },
                LootEntry { item_id: "health_potion".to_string(), weight: 35, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "antidote".to_string(), weight: 25, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "ghost_essence".to_string(), weight: 20, quantity_min: 1, quantity_max: 1 },
            ],
            gold_min: 10, gold_max: 30,
            roll_count: 2,
        ...
        LootTable {
            id: "sunken_temple_sanctum".to_string(),
            flavor_text: "The inner sanctum of the Sunken Temple has remained sealed for \
                          centuries. Offerings and artefacts of incalculable age surround \
                          the central altar — a fortune in ancient power.".to_string(),
            guaranteed_items: vec![
                ("ancient_coin".to_string(), 6),
                ("ghost_essence".to_string(), 2),
                ("temple_relic".to_string(), 2),
            ],
            random_entries: vec![
                LootEntry { item_id: "temple_seal_amulet".to_string(), weight: 50, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "black_iron_sword".to_string(), weight: 30, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "health_potion".to_string(), weight: 60, quantity_min: 2, quantity_max: 3 },
                LootEntry { item_id: "runic_short_sword".to_string(), weight: 20, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "clarity_potion".to_string(), weight: 35, quantity_min: 1, quantity_max: 2 },
            ],
            gold_min: 40, gold_max: 90,
            roll_count: 4,
        },
        // ── Frostpeak ─────────────────────────────────────────────────────────
        LootTable {
            id: "frostpeak_approach".to_string(),
            flavor_text: "You search among the frozen rocks of the approach path. \
                          Frost-preserved remains of past travellers yield a few useful items.".to_string(),
            guaranteed_items: vec![("frost_crystal".to_string(), 1)],
            random_entries: vec![
                LootEntry { item_id: "glacier_shard".to_string(), weight: 50, quantity_min: 1, quantity_max: 2 },
                LootEntry { item_id: "wolf_pelt".to_string(), weight: 40, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "health_potion".to_string(), weight: 25, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "meat".to_string(), weight: 35, quantity_min: 1, quantity_max: 2 },
            ],
            gold_min: 0, gold_max: 10,
            roll_count: 2,
        },
        LootTable {
            id: "frostpeak_summit".to_string(),
            flavor_text: "The frozen summit holds a trove of gear left by adventurers who never \
                          descended, preserved perfectly by the eternal cold.".to_string(),
            guaranteed_items: vec![
                ("glacier_shard".to_string(), 3),
                ("frost_crystal".to_string(), 2),
            ],
            random_entries: vec![
                LootEntry { item_id: "frostpeak_amulet".to_string(), weight: 40, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "frost_helm".to_string(), weight: 35, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "iron_long_bow".to_string(), weight: 25, quantity_min: 1, quantity_max: 1 },
                LootEntry { item_id: "health_potion".to_string(), weight: 50, quantity_min: 2, quantity_max: 3 },
                LootEntry { item_id: "clarity_potion".to_string(), weight: 30, quantity_min: 1, quantity_max: 2 },
            ],
